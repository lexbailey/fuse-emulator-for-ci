...
static void fuse_show_help( void )
{
  ...
  printf(
   ...
   "--screenshot-file      Save a screenshot as a PNG to this file when the specified address is fetched.\n"
   "--screenshot-addr      Take the screenshot when this fetch address is reached.\n"
   "--halt-on-fetch        Halt FUSE when the specified address is fetched.\n"
   "\n"
   "For help, please mail <fuse-emulator-devel@lists.sf.net> or use\n"
   "the forums at <http://sourceforge.net/p/fuse-emulator/discussion/>.\n"
